...
func generateForType(t interface{}, representation string) error {
	...
	f.Add(genFunc(name, "Equal", []jen.Code{jen.Id("value").Id(v.Type().Name())}, jen.Op("[]interface{}").Values(jen.Id("value")), jen.Return(
		jen.Qual("github.com/otto-eng/go-hit/internal/minitest", "Equal").Call(jen.Id("v").Dot("valueCallback").Call(jen.Id("hit")), jen.Id("value")),
	)))
	...
	f.Add(genFunc(name, "NotEqual", []jen.Code{jen.Id("values").Op("...").Id(v.Type().Name())}, jen.Op(fmt.Sprintf("%sSliceToInterfaceSlice", v.Type().Name())).Call(jen.Id("values")), jen.Return(
		jen.Qual("github.com/otto-eng/go-hit/internal/minitest", "NotEqual").Call(jen.Id("v").Dot("valueCallback").Call(jen.Id("hit")), jen.Op(fmt.Sprintf("%sSliceToInterfaceSlice", v.Type().Name())).Call(jen.Id("values")).Op("...")),
	)))
	...
	f.Add(genFunc(name, "OneOf", []jen.Code{jen.Id("values").Op("...").Id(v.Type().Name())}, jen.Op(fmt.Sprintf("%sSliceToInterfaceSlice", v.Type().Name())).Call(jen.Id("values")), jen.Return(
		jen.Qual("github.com/otto-eng/go-hit/internal/minitest", "OneOf").Call(jen.Id("v").Dot("valueCallback").Call(jen.Id("hit")), jen.Op(fmt.Sprintf("%sSliceToInterfaceSlice", v.Type().Name())).Call(jen.Id("values")).Op("...")),
	)))
	...
	f.Add(genFunc(name, "NotOneOf", []jen.Code{jen.Id("values").Op("...").Id(v.Type().Name())}, jen.Op(fmt.Sprintf("%sSliceToInterfaceSlice", v.Type().Name())).Call(jen.Id("values")), jen.Return(
		jen.Qual("github.com/otto-eng/go-hit/internal/minitest", "NotOneOf").Call(jen.Id("v").Dot("valueCallback").Call(jen.Id("hit")), jen.Op(fmt.Sprintf("%sSliceToInterfaceSlice", v.Type().Name())).Call(jen.Id("values")).Op("...")),
	)))
	...
	f.Add(genFunc(name, "GreaterThan", []jen.Code{jen.Id("value").Id(v.Type().Name())}, jen.Op("[]interface{}").Values(jen.Id("value")), jen.Add(
		...
		jen.If(
			jen.Id("l").Op("<=").Id("value").Block(
				jen.Return(
					jen.Qual("github.com/otto-eng/go-hit/internal/minitest", "Errorf").Call(jen.Lit(fmt.Sprintf("expected %[1]s to be greater than %[1]s", representation)), jen.Id("l"), jen.Id("value")),
				),
			),
		),
		jen.Line(),
	...
	f.Add(genFunc(name, "LessThan", []jen.Code{jen.Id("value").Id(v.Type().Name())}, jen.Op("[]interface{}").Values(jen.Id("value")), jen.Add(
		...
		jen.If(
			jen.Id("l").Op(">=").Id("value").Block(
				jen.Return(
					jen.Qual("github.com/otto-eng/go-hit/internal/minitest", "Errorf").Call(jen.Lit(fmt.Sprintf("expected %[1]s to be less than %[1]s", representation)), jen.Id("l"), jen.Id("value")),
				),
			),
		),
		jen.Line(),
	...
	f.Add(genFunc(name, "GreaterOrEqualThan", []jen.Code{jen.Id("value").Id(v.Type().Name())}, jen.Op("[]interface{}").Values(jen.Id("value")), jen.Add(
		...
		jen.If(
			jen.Id("l").Op("<").Id("value").Block(
				jen.Return(
					jen.Qual("github.com/otto-eng/go-hit/internal/minitest", "Errorf").Call(jen.Lit(fmt.Sprintf("expected %[1]s to be greater or equal than %[1]s", representation)), jen.Id("l"), jen.Id("value")),
				),
			),
		),
		jen.Line(),
	...
	f.Add(genFunc(name, "LessOrEqualThan", []jen.Code{jen.Id("value").Id(v.Type().Name())}, jen.Op("[]interface{}").Values(jen.Id("value")), jen.Add(
		...
		jen.If(
			jen.Id("l").Op(">").Id("value").Block(
				jen.Return(
					jen.Qual("github.com/otto-eng/go-hit/internal/minitest", "Errorf").Call(jen.Lit(fmt.Sprintf("expected %[1]s to be less or equal than %[1]s", representation)), jen.Id("l"), jen.Id("value")),
				),
			),
		),
		jen.Line(),
	...
	f.Add(genFunc(name, "Between", []jen.Code{jen.Id("min"), jen.Id("max").Id(v.Type().Name())}, jen.Op("[]interface{}").Values(jen.Id("min"), jen.Id("max")), jen.Add(
		...
		jen.If(
			jen.Id("l").Op("<").Id("min").Op("||").Id("l").Op(">").Id("max").Block(
				jen.Return(
					jen.Qual("github.com/otto-eng/go-hit/internal/minitest", "Errorf").Call(jen.Lit(fmt.Sprintf("expected %[1]s to be between %[1]s and %[1]s", representation)), jen.Id("l"), jen.Id("min"), jen.Id("max")),
				),
			),
		),
		jen.Line(),
	...
	f.Add(genFunc(name, "NotBetween", []jen.Code{jen.Id("min"), jen.Id("max").Id(v.Type().Name())}, jen.Op("[]interface{}").Values(jen.Id("min"), jen.Id("max")), jen.Add(
		...
		jen.If(
			jen.Id("l").Op(">=").Id("min").Op("&&").Id("l").Op("<=").Id("max").Block(
				jen.Return(
					jen.Qual("github.com/otto-eng/go-hit/internal/minitest", "Errorf").Call(jen.Lit(fmt.Sprintf("expected %[1]s not to be between %[1]s and %[1]s", representation)), jen.Id("l"), jen.Id("min"), jen.Id("max")),
				),
			),
		),
		jen.Line(),
